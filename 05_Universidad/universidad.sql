...
-- CREATEs
CREATE TABLE departamento(id int primary key auto_increment,
							nombre varchar(50) not null);
                            
CREATE TABLE grado(id int primary key auto_increment,
					nombre varchar(100) not null);
                    
CREATE TABLE curso_escolar(id int primary key auto_increment,
...
CREATE TABLE profesor(id_profesor int primary key auto_increment,
						id_departamento int,
                        foreign key (id_departamento) references departamento(id));
                        
CREATE TABLE asignatura(id int primary key auto_increment,
						nombre varchar(100) not null,
...
CREATE TABLE alumno_se_matricula_asignatura(id_alumno int,
											id_asignatura int,
