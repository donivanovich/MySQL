...
-- CREATEs
CREATE TABLE gama_producto(gama VARCHAR(50) primary key,
						   descripcion_texto TEXT,
                           descripcion_html TEXT,
                           imagen VARCHAR(256)
						   );
CREATE TABLE oficina(codigo_oficina VARCHAR(10) primary key,
...
CREATE TABLE producto(codigo_producto VARCHAR(15) primary key,
...
CREATE TABLE empleado(codigo_empleado INT primary key auto_increment,
...
CREATE TABLE pago(codigo_cliente INT NOT NULL,
...
CREATE TABLE pedido(codigo_pedido INT primary key auto_increment,
...
CREATE TABLE detalle_pedido(codigo_pedido INT NOT NULL,
